...
class User(AbstractUser):
    ...
    def save(self, *args, **kwargs):
        user_folder = os.path.join('base_datasets', self.username)
        ...
        if not os.path.exists(user_folder):
            ...
            for basic_dataset in os.listdir(os.path.join('documents', 'base_datasets')):
                ...
                path_to_save_folder = os.path.join('base_datasets', self.username,
    ...
    def delete(self, *args, **kwargs):
        for dataset in self.datasets.all():
            dataset.delete()
        if os.path.exists(os.path.join('base_datasets', self.username)):
            clear_dir(os.path.join('base_datasets', self.username))
