...
export default function Aside() {
  ...
  return (
    <aside
      ...
      class="flex flex-col h-screen justify-between w-80 z-40 transition-transform -translate-x-full sm:translate-x-0 border-r border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-indigo-50 relative"
      aria-label="Sidebar"
    >
      <div class="px-3 py-4 w-full">
        ...
        >
          <div
            id="dropdown-cta"
            className="p-4 mt-6 rounded-lg bg-blue-100 dark:bg-blue-900"
            role="alert"
          >
        ...
        <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span class="ml-3">Документация</span>
            </a>
          </li>
          <li>
            <a
