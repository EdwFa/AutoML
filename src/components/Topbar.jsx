...
const navigation = [
  { name: "Загрузка", href: "#", current: true },
  { name: "Просмотр", href: "#", current: false },
  { name: "Графики", href: "#", current: false },
  { name: "Статистика", href: "#", current: false },
  { name: "Обучение", href: "#", current: false },
];
                          ...
                          <a
                            ...
                            className={classNames(
                              item.current
                                ...
                                : "text-gray-700 hover:bg-gray-200 hover:ttext-gray-800",
