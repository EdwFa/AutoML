            ...
            <div className="bg-white border-gray-200 px-4 dark:bg-gray-800">
              <div className="h-dvh flex flex-col bg-white dark:bg-gray-800">
                <div className="flex items-center justify-between">
                  <div className="my-4 font-bold">Ваши Модели</div>
                </div>
                      ...
                      <div className="block p-4 bg-gray-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div>
                          ...
                          <button
                            type="button"
                            disabled={loading}
                            className="px-3 mt-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                      ...
                      {modelInfo ? (
                        <div className="col-span-2">
                          ...
                          <button
                            type="button"
                            disabled={loading}
                            className="my-4 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
